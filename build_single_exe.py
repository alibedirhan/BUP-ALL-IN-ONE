...
# -*- coding: utf-8 -*-
"""
BupiliÇ Single EXE Builder - GÜNCELLENMİŞ
CustomTkinter alt modüllerini düzgünce PyInstaller'a dahil eder.
"""
...
def generate_spec_file():
    spec_file = Path("bupilic_auto.spec")
...
"""
    ...
    print("✅ Spec dosyası başarıyla oluşturuldu.")

def main():
    generate_spec_file()
    cmd = [sys.executable, "-m", "PyInstaller", "--noconfirm", "--clean", "bupilic_auto.spec"]
