# export_manager.py - DÜZELTILMIŞ VE TEMİZLENMİŞ
import os
...
class ExportManager:
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('export_manager.log', encoding='utf-8'),
    ...
    def get_clean_filename(self, pdf_name):
        ...
        return clean_name if clean_name else "Fiyat_Listesi"
            ...
            with pd.ExcelWriter(file_path, engine='openpyxl') as writer:
                ...
                for sheet_idx, (pdf_name, pdf_data) in enumerate(all_pdf_data.items(), 1):
                    ...
                    for category, products in pdf_data['data'].items():
                        ...
                        sheet_data.append({
                            'Kategori': category,
                            'Ürün Adı': f'%{discount_rate:.1f} İSKONTO UYGULANMIŞ',
                            'Orj. KDV Hariç (TL)': '',
                            'Orj. KDV Dahil (TL)': '',
                            'İsk. KDV Hariç (TL)': '',
                            'İsk. KDV Dahil (TL)': '',
    ...
    def _format_excel_sheet(self, writer, sheet_name, df):
        ...
        try:
            ...
            logging.warning(f"Excel formatlama hatası: {e}")
    ...
    def _add_pdf_summary_page(self, pdf, data, discount_vars):
        ...
        for category, products in data.items():
            if products:
                ...
                safe_category = self.safe_turkish_text(category)
                if len(safe_category) > 30:
                    safe_category = safe_category[:27] + "..."
...
class SafePDF(FPDF):
    ...
    def _load_fonts(self):
        ...
        try:
            ...
            logging.warning(f"Font yükleme başarısız, varsayılan font kullanılacak: {e}")
